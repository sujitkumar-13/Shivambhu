      ...
      <section className="pt-32 pb-16 md:pt-48 md:pb-24 bg-[linear-gradient(to_bottom,rgba(8,145,178,0.05),white)]">
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20 text-center">
          <ScrollReveal direction="up">
            <span className="bg-cyan-50 border border-cyan-100 text-cyan-600 text-sm font-bold px-5 py-2.5 rounded-full mb-6 inline-block tracking-wide uppercase">
              Our Story
            </span>
        ...
        <div className="w-full px-4 sm:px-6 md:px-10 lg:px-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24">
            <ScrollReveal direction="right">
              <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 h-full">
                <div className="bg-cyan-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-8">
                  <i className="ri-scales-3-line text-cyan-600 text-3xl"></i>
                </div>
                <h3 className="text-slate-800 text-2xl md:text-3xl font-bold mb-6">Our Mission</h3>
            ...
            <ScrollReveal direction="left">
              <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 h-full">
                ...
                <h3 className="text-slate-800 text-2xl md:text-3xl font-bold mb-6">Our Vision</h3>
                <p className="text-slate-600 leading-relaxed text-base md:text-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <ScrollReveal key={index} direction="up" delay={index * 0.1}>
                <div className="flex flex-col items-center text-center p-6 rounded-3xl hover:bg-cyan-50/50 transition-colors duration-300">
                  <div className="w-14 h-14 bg-white shadow-lg rounded-2xl flex items-center justify-center mb-6 text-cyan-600 text-2xl border border-slate-50">
                    <i className={item.icon}></i>
                  </div>
                  <h4 className="text-slate-800 font-bold mb-3 text-lg">{item.title}</h4>
