          ...
          <div className="box-border caret-transparent flex-1 relative">
            <div className="relative box-border caret-transparent">
              <img
                alt="Pure Water"
                src={pipes.src}
                className="shadow-[rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0)_0px_0px_0px_0px,rgba(0,0,0,0.25)_0px_25px_50px_-12px] box-border caret-transparent max-w-full w-full rounded-3xl"
              />
