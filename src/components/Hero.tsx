...
export const Hero = () => {
  return (
    <section id="home" className="relative items-center flex min-h-screen md:min-h-[800px] overflow-hidden pt-24 md:pt-32">
      ...
      <div className="relative w-full px-6 py-12 md:px-10 lg:px-20">
        <div className="items-center gap-x-12 grid grid-cols-1 lg:grid-cols-2 gap-y-16">
          {/* Hero Content Column */}
          <div className="flex flex-col items-start z-10 order-2 lg:order-1">
            <ScrollReveal direction="left">
              ...
              <p className="text-slate-600 text-sm sm:text-base md:text-lg leading-relaxed max-w-lg mt-6">
              ...
              <div className="gap-4 flex flex-col sm:flex-row items-center md:justify-start mt-8 w-full sm:w-auto">
                ...
                <button className="w-full sm:w-auto text-cyan-600 font-semibold items-center justify-center bg-white/50 backdrop-blur-sm flex text-center border-cyan-600 px-8 py-4 rounded-full border-2 hover:bg-cyan-50 transition-all active:scale-95">
                  <span>Learn More</span>
                </button>
              </div>

              <div className="items-center justify-start flex flex-wrap gap-4 sm:gap-6 mt-10 pt-4 border-t border-slate-200/50 md:border-none">
              ...
              <div className="relative group">
                ...
                <div className="relative z-10 overflow-hidden rounded-3xl shadow-[0_20px_50px_rgba(8,145,178,0.2)] transform transition-transform duration-500 hover:scale-[1.02]">
                  <img
                    alt="Pure Water"
                    src={water.src}
                    className="w-full h-[350px] sm:h-[450px] md:h-[550px] lg:h-auto object-cover"
                  />
                </div>

                {/* Statistics Card */}
                <div className="absolute bg-white/95 backdrop-blur-md shadow-2xl p-4 md:p-6 rounded-2xl -left-2 md:-left-8 -bottom-4 md:-bottom-6 lg:-bottom-8 z-20 border border-white/50 animate-bounce-subtle">
                  <div className="text-cyan-600 text-xl md:text-2xl lg:text-3xl font-bold">5000+</div>
                ...
                <div className="absolute bg-cyan-600 shadow-xl p-3 md:p-4 rounded-2xl -right-2 md:-right-6 -top-4 z-20 flex items-center justify-center transition-transform hover:rotate-12">
                  <i className="text-white text-xl md:text-2xl lg:text-3xl ri-award-fill"></i>
                </div>
              </div>
            </ScrollReveal>
          </div>
