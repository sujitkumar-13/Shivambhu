...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed z-50 py-5 top-0 inset-x-0 bg-white/80 backdrop-blur-md">
      <div className="w-full px-4 md:px-20">
        <div className="items-center flex justify-between">
          ...
          <button 
            ...
            className="text-slate-700 bg-transparent block p-2 md:hidden"
          >
        ...
        {/* Mobile Menu */}
        <div className={`border-gray-100 mt-4 py-4 border-t border-solid md:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
